  ...
  <main class="home">
    ...
    <div class="destination-ideas">
      <div class="destination2">
        <p class="dest-name">India</p>
        <img width="370px" height="370px" src="../assets/hotel2.jpeg" alt="hotel2"/>
      </div>
      <div class="destination1">
        <p class="dest-name">San Francisco</p>
        <img width="370px" height="370px"  src="../assets/hotel1.jpg" alt="hotel1"/>
      </div>
      <div class="destination3">
        <p class="dest-name">San Diego</p>
      <img width="370px" height="370px" src="../assets/hotel3.jpg" alt="hotel3"/>
      </div>
    </div>
  </main>
</template>
